<div class="mx-5">
    <h3 class="text-xl font-bold my-3 bg-transparent">Mijn reserveringen</h3>
    @foreach($reserveringen as $user => $reservering)
        {{$user}}
        @livewire('components.cadeautable.table', ['cadeaus' => $reservering, 'isMyList' => false], key($user))
        @livewire('components.grid.cadeau-grid', ['cadeaus' => $reservering, 'isMyList' => false])
    @endforeach
